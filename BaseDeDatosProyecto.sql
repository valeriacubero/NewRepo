...
(--ESTA TABLA SE LLENA CUANDO EL USER CIERRA LA PESTAÑA DE VER CAPITULO Y DEJÓ SU RESEÑA Y VALORACIÓN
 ...
 stars INT NOT NULL,
 review VARCHAR(8000) NULL,
 CONSTRAINT fk_idUserS FOREIGN KEY (idUser) REFERENCES ACCOUNT (idAccount),
 CONSTRAINT fk_idSerieU FOREIGN KEY (idSerie) REFERENCES SERIE (idSerie) ON DELETE CASCADE
)
